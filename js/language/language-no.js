...
<ul>
  ...
  <li><strong>Eksport / import (flytt eller sikkerhetskopier prompter):</strong> Klikk <strong>Eksporter</strong> og velg JSON-fil, Microsoft OneDrive eller Google Drive. Skysikkerhetskopien inneholder alle 20 promptplassene og navnene i den aktive profilen, krypteres i nettleseren med passordet du velger, og lagres i den private appmappen på din egen konto. En ny skyeksport erstatter bare den forrige promptkopien hos samme tjeneste; den overskriver ikke sikkerhetskopien av API-nøkler eller andre filer. For å hente promptene velger du <strong>Importer</strong>, samme tjeneste og skriver inn passordet. Import erstatter alltid promptene i den <strong>aktive</strong> profilen og advarer hvis kopien kommer fra en annen profil.</li><br>
