...
- <strong>Cookie Usage:</strong> Our website uses cookies to store user preferences and manage consent for personalized ads, enhancing your experience. You can manage your cookie settings via the consent banner on our site.<br><br>
- <strong>Third-Party Sharing:</strong> We do not sell or share your personal data with third parties. Data is shared only with trusted external services (such as OpenAI for transcription and note generation, and Google AdSense for ad personalization) under strict privacy standards.<br><br>
