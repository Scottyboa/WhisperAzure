...
function injectManagerStyle() {
  ...
  style.textContent = `
    ...
    .workspace-preset-frame-host{position:relative;width:100%;overflow:hidden}.workspace-preset-frame{border:0;background:#f8f8f8}.workspace-preset-frame.is-active{position:relative;display:block;width:100%;min-height:600px;visibility:visible;opacity:1;pointer-events:auto}.workspace-preset-frame.is-parked{position:absolute;left:0;top:0;display:block;width:100%!important;min-height:600px;visibility:hidden;opacity:0;pointer-events:none}
