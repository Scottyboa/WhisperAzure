...
function injectManagerStyle() {
  const style = document.createElement("style");
  style.textContent = `
    .workspace-preset-bar{display:flex;align-items:center;gap:8px;min-height:49px;margin:0 0 11px;padding:7px 11px;border:1px solid #e1e7e4;border-radius:10px;background:#fbfcfb;color:#4b5550;font-size:14px;box-sizing:border-box}
    .workspace-preset-bar button,.workspace-modal button{margin:0}.workspace-preset-bar button{font:inherit}.workspace-preset-help{position:relative;width:27px;height:27px;padding:0;border:1px solid #b8c6c0;border-radius:50%;background:#fff;color:#46705f;font-weight:700;cursor:help;flex:0 0 auto}
    ...
    .workspace-preset-io{padding:6px 11px;border:1px solid #cbd5d1;border-radius:7px;background:#fff;color:#3d5148;cursor:pointer}.workspace-preset-io:hover{background:#f1f7f4}
    .workspace-preset-label{margin-left:12px;color:#68746f;font-weight:600;white-space:nowrap}.workspace-preset-list{display:flex;align-items:center;gap:8px;min-width:0;overflow-x:auto;padding:2px 0;scrollbar-width:thin}
    .workspace-preset-chip{display:inline-flex;align-items:center;gap:7px;flex:0 0 auto;min-height:33px;padding:6px 8px 6px 12px;border:1px solid #d2dad6;border-radius:999px;background:#fff;color:#34463e;cursor:pointer;max-width:230px}.workspace-preset-chip:hover{background:#f2f8f5;color:#34463e}
