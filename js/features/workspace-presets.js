...
function injectManagerStyle() {
  const style = document.createElement("style");
  style.textContent = `
    .workspace-preset-bar{display:flex;align-items:center;gap:10px;min-height:58px;margin:0 0 13px;padding:9px 13px;border:1px solid #e1e7e4;border-radius:11px;background:#fbfcfb;color:#4b5550;font-size:15px;box-sizing:border-box}
    .workspace-preset-bar button,.workspace-modal button{margin:0}.workspace-preset-bar button{font:inherit}.workspace-preset-help{position:relative;width:30px;height:30px;padding:0;border:1px solid #b8c6c0;border-radius:50%;background:#fff;color:#46705f;font-weight:700;cursor:help;flex:0 0 auto}
    ...
    .workspace-preset-io{padding:7px 13px;border:1px solid #cbd5d1;border-radius:8px;background:#fff;color:#3d5148;cursor:pointer}.workspace-preset-io:hover{background:#f1f7f4}
    .workspace-preset-label{margin-left:14px;color:#68746f;font-weight:600;white-space:nowrap}.workspace-preset-list{display:flex;align-items:center;gap:9px;min-width:0;overflow-x:auto;padding:3px 0;scrollbar-width:thin}
    .workspace-preset-chip{display:inline-flex;align-items:center;gap:8px;flex:0 0 auto;min-height:39px;padding:8px 10px 8px 14px;border:1px solid #d2dad6;border-radius:999px;background:#fff;color:#34463e;cursor:pointer;max-width:250px}.workspace-preset-chip:hover{background:#f2f8f5;color:#34463e}
    ...
    .workspace-preset-close{border:0;background:transparent;color:#87918d;padding:0 2px;line-height:1;font-size:17px;cursor:pointer}.workspace-preset-close:hover{color:#a4001e}.workspace-preset-add{width:38px;height:38px;padding:0;border:1px dashed #aebbb5;border-radius:50%;background:#fff;color:#426857;font-size:22px;line-height:1;cursor:pointer;flex:0 0 auto}
